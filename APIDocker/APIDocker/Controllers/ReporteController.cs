...
public class ReporteController : ControllerBase
{
    ...
    public async Task<IActionResult> ConexionDocker()
    {
        try
        {
            ...
            var response = await client.GetAsync("https://192.168.1.100:44305/Citas/TodasCitas");
    ...
    public async Task<IActionResult> ConexionDocker(long idSucursal)
    {
        try
        {
            ...
            var client = _clientFactory.CreateClient();
            var response = await client.GetAsync($"https://localhost:44305/Citas/ConsultarCitaPorSucursal?idSucursal={idSucursal}");
    ...
    public async Task<IActionResult> TotalCitasPorMes(int mes)
    {
        try
        {
            ...
            var response = await client.GetAsync($"https://localhost:44305/Citas/ConsultarCitaPorMes?fecha={fecha:yyyy-MM-dd}");
    ...
    public async Task<IActionResult> TotalCitasPorSemana(DateTime fecha)
    {
        try
        {
            ...
            var response = await client.GetAsync($"https://localhost:44305/Citas/ConsultarCitaPorSemana?fecha={fecha:yyyy-MM-dd}");
